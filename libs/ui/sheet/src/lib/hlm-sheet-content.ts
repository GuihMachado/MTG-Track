...
export const sheetVariants = cva(
	'bg-sidebar data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 shadow-elev-3 transition ease-in-out data-[state=closed]:duration-200 data-[state=open]:duration-260',
	{
		variants: {
			side: {
